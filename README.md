我来帮你整理一个完整、详细、结构清晰的 README，把扩展 DLL 和逻辑体 DLL 的区别、能力、以及操作方式都写清楚。
...
>
> SuperConsole 给你**创造功能的能力**，功能没有上限。
...
3. 放置文件
   → SuperConsole.dll 放到 BepInEx/plugins/
...
- [BepInEx](https://github.com/BepInEx/BepInEx) - Unity 插件框架
- [Harmony](https://github.com/pardeike/Harmony) - 运行时补丁库
- [Roslyn](https://github.com/dotnet/roslyn) - C# 编译器
